...
public class KnapsackRunner {
    ...
    // Create an instance of for each algorithm
    static WholeDynamic wholeDynamic = new WholeDynamic();
    static FractionalDynamic fractionalDynamic = new FractionalDynamic();
    static WholeGreedy wholeGreedy = new WholeGreedy();
    static FractionalGreedy fractionalGreedy = new FractionalGreedy();
